exports.run = {
   usage: ['antiporn', 'captcha', 'antidelete', 'autosticker', 'viewonce', 'antibot', 'antilink', 'antivirtex', 'left', 'filter', 'localonly', 'welcome', 'game'],
   use: 'on / off',
   ...
   async: async (m, {
      ...
      try {
         ...
         if (!isBotAdmin && /antibot|antilink|antivirtex|filter|localonly/.test(type)) return client.reply(m.chat, global.status.botAdmin, m)
