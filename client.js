...
const { Baileys, MongoDB, PostgreSQL, Scandir, Function: Func } = new(require('@neoxr/neoxr-js'))
const fs = require('fs')
...
const client = new Baileys({
   ...
   setup: env.setup // for default (don't change it)
})

/* starting to connect */
client.on('connect', async res => {
   /* load database */
   global.db = {users:[], chats:[], groups:[], statistic:{}, sticker:{}, setting:{}, menfess:[], memoryStore: '', ...(await machine.fetch() ||{})}  
